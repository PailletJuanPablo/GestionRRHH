...
<div class="card">
   <div class="header bg-cyan">
      ...
      <h3> HORAS DISPONIBLES: {{  $horasExtra->sum("cantidad") - $empleado->salidasParticulares()->sum("cantidad_horas")}}</h3>
      <h3> DIAS FRANCOS COMPENSATORIOS DISPONIBLES: {{($horasExtra->sum("cantidad") - $empleado->salidasParticulares()->sum("cantidad_horas"))/ 6}}</h3>
   </div>
...
@endif
@if ($empleado->salidasParticulares->count() > 0)
<div class="card">
